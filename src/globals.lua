...
local RADPI = 57.295779513082 --- 180/math.pi
...
function GB_GLOBALS.CanWeaponShoot()
	...
	old_weapon = weapon
    if math.floor(weapon:GetWeaponData().timeFireDelay * 10) / 10 <= 0.1 then return true end
